    ...
    if (isdev) {
      ...
      function getPagedProjects(url) {
        ...
        if (url === null) {
          ...
          url +=
            ',PPID/Title,PM/Title,PjMCode/Title,PjMCode/Branch,PjMCode/Div,DeliverableMilestonesEditRecord/Title'
          url += '&$expand=PPID,PM,PjMCode,DeliverableMilestonesEditRecord' // DeliverableMilestonesEditRecord is Y if there are milestones
